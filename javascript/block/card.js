...
var $wrapCard = document.querySelector('.wrap-cards'); // guarda na var o OL pai dos cards
var $bolinhas = document.querySelectorAll('.bolinha'); // guarda na var $bolinha todos os elementos que possuem a classe bolinha

$wrapCard.addEventListener('click', function(event){ // coloquei uma escuta na ol, quando clicarem vai rodar a function
    ...
    var $card = $this.parentNode.parentNode.parentNode // $this é a bolinha, então eu subo de nível 3x, pra pegar o card 
